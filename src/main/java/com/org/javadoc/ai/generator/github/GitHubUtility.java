...
public class GitHubUtility {
    ...
    public String createPullRequest(List<String> classNames, String description) throws IOException {
        try {
            ...
            logger.info("Title: {}", pullRequest.getTitle()); // Format specifiers used here
            logger.info("Number: {}", pullRequest.getNumber()); // Format specifiers used here
            logger.info("URL: {}", pullRequest.getHtmlUrl()); // Format specifiers used here
